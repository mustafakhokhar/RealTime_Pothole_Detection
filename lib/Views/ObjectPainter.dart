...
import 'package:pothole_detection_realtime/Helper/cordinates_translator.dart';
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final DetectedObject detectedObject in _objects) {
      ...
      if (detectedObject.labels.isNotEmpty) {
        ...
        builder.addText('${label.text} ${label.confidence.toStringAsFixed(2)} ${detectedObject.trackingId.toString()} \n');
      }
      builder.pop();
